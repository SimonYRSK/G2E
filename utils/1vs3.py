...
def main():
    ...
    for date in args.dates:
        ...
        plt.plot(steps, data_1yr["acc_trans"], label="GFS2ERA5 L1+GRADLOSS", marker="o")
        plt.plot(steps, data_3yr["acc_trans"], label="GFS2ERA5 L2", marker="o")
        ...
        plt.plot(steps, data_1yr["rmse_trans"], label="GFS2ERA5 L1+GRADLOSS", marker="o")
        plt.plot(steps, data_3yr["rmse_trans"], label="GFS2ERA5 L2", marker="o")
        plt.xlabel("Forecast Step")
        plt.ylabel("RMSE")
