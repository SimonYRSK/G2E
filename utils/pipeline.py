...
def main():
    ...
    parser.add_argument("--model_tag", type=str, default="1yr", choices=["3yr", "1yr"])
    parser.add_argument(
        "--dates",
        type=str,
        nargs="+",
        default=["20250501", "20250601"],
    )
    parser.add_argument("--device", type=str, default="cuda")

    parser.add_argument("--checkpoint_path", type=str, default="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/swinunet_2022_2024_1yr_3_27/checkpoint_epoch_24.pth")
    parser.add_argument("--model_suffix", type=str, default="3_27")
