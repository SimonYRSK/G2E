...
from data.pairsetc226 import GFS2ERA5Dataset
...
def main():
    ...
    trainer = FSDPUNetTrainer(
        ...
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/mainc226",
        save_interval=1,
        use_amp=False,
        rank=rank,
        ...
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/channelpics/mainc226",
