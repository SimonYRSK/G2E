...
class Fuxi(nn.Module):
    ...
    """
    def __init__(self, img_size=(2, 721, 1440), patch_size=(2, 4, 4), in_chans=10, out_chans=10,
                 embed_dim=864, num_groups=32, num_heads=8, window_size=7):
        super().__init__()
        ...
        self.u_transformer = UTransformer(embed_dim, num_groups, input_resolution, num_heads, window_size, depth=16)
    ...
    def forward(self, x: torch.Tensor):
        ...
        Lat, Lon = self.input_resolution  #(721/4/2, 1440/4/2) = (90, 180)
        Lat, Lon = Lat * 2, Lon * 2
...
if __name__ == '__main__':
    B = 1  # batch_size
    in_chans = out_chans = 10  # number of input channels or output channels
