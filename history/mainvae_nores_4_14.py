...
def main():
    ...
    trainer = FSDPUNetTrainerDiff(
        ...
        device=device,
        beta=1e-4,
        tb_dir="/home/ximutian/tensorboard_logs/swinvae_nores_diff_4_14",
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/swinvae_nores_diff_4_14",
        save_interval=1,
        use_amp=False,
        rank=rank,
        ...
        kl_anneal=True,
        kl_anneal_epochs=7,
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/channelpics/swinvae_nores_diff_4_14",
