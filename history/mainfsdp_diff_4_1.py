...
def main():
    ...
    trainer = FSDPUNetTrainerDiff(
        ...
        device=device,
        beta=1e-4,
        tb_dir="/home/ximutian/tensorboard_logs/swinunet_diff_2022_2024_3yr_4_1",
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/swinunet_diff_2022_2024_3yr_4_1",
        save_interval=1,
        use_amp=False,
        rank=rank,
        ...
        kl_anneal=False,
        kl_anneal_epochs=7,
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/channelpics/swinunet_diff_2022_2024_3yr_4_1",
    )
