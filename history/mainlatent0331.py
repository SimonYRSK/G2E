...
from models.swinUnetLatent import G2ELatent as G2E
from trainers.trainLatent import FSDPLatentTrainer as Trainer
...
def main():
    if "RANK" not in os.environ:
        raise RuntimeError("mainfsdp.py 需要通过 torchrun 启动，例如: torchrun --nproc_per_node=2 mainfsdp0331.py")
    ...
    trainer = Trainer(
        ...
        tb_dir="/home/ximutian/tensorboard_logs/swinunet_mmd_2022_2024_1yr_3_31",
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/swinunet_mmd_2022_2024_1yr_3_31",
        save_interval=1,
        use_amp=False,
        rank=rank,
        ...
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/channelpics/swinunet_mmd_2022_2024_1yr_3_31",
        mmd_weight=1e-2,
    )
