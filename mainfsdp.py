...
def main():
    ...
    trainer = FSDPUNetTrainer(
        ...
        tb_dir="/home/ximutian/tensorboard_logs/swinunet_fsdp_2023_3_18",
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/G2E/checkpoints/swinunet_fsdp_2023_3_18",
        save_interval=1,
        use_amp=True,
        rank=rank,
